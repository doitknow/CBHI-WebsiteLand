...
<template>
  ...
  >
    ...
    <div
      class="relative w-full min-h-[550px] sm:min-h-[640px] pb-[120px] sm:pb-[100px]"
    >
      <!-- Mobile Simple Background Slider -->
      <div class="block lg:hidden pointer-events-none absolute inset-0 overflow-hidden z-0">
        <!-- Gradient overlay for text readability on mobile -->
        <div class="absolute inset-0 bg-gradient-to-b from-[#fcfcfd] via-[#fcfcfd]/90 to-transparent dark:from-[#021E31] dark:via-[#021E31]/90 dark:to-transparent z-10"></div>
        <div 
          class="w-full h-full flex transition-transform duration-[1000ms] ease-in-out"
      ...
      <!-- Animated SVG Wave Background with Cinematic Entrance (Desktop Only) -->
      <div
        class="hidden lg:block pointer-events-none absolute inset-0 overflow-hidden bg-transparent hero-image-area"
      ...
      <div
        class="relative z-10 flex flex-col items-start px-5 sm:px-16 pt-[40px] sm:pt-[52px] lg:w-[46%] lg:px-[101px]"
      >
        ...
        <div class="animate-float animate-scale-in anim-delay-8 mt-6 sm:mt-8 inline-flex items-center gap-3 sm:gap-4 rounded-2xl bg-white/80 dark:bg-slate-900/80 p-2 sm:p-2.5 shadow-sm backdrop-blur-sm ring-1 ring-slate-100 dark:ring-white/10 lg:mt-[42px]">
          <div class="flex items-center">
            <div class="h-6 w-6 sm:h-8 sm:w-8 rounded-full border-2 border-white bg-[#c4d6f0] shadow-sm" />
            <div class="-ml-2 sm:-ml-2.5 h-6 w-6 sm:h-8 sm:w-8 rounded-full border-2 border-white bg-[#a8c4e4] shadow-sm" />
            <div class="-ml-2 sm:-ml-2.5 h-6 w-6 sm:h-8 sm:w-8 rounded-full border-2 border-white bg-[#8cb2d8] shadow-sm" />
            <span
              class="-ml-2 sm:-ml-2.5 flex h-6 w-6 sm:h-8 sm:w-8 items-center justify-center rounded-full border-2 border-white bg-[#22c55e] text-[7px] sm:text-[9px] font-bold text-white shadow-sm"
            >
              2M+
            </span>
          </div>
          <p class="pr-2 text-[9px] sm:text-[10px] font-semibold leading-[1.35]">
      ...
      <div class="absolute bottom-[90px] right-4 sm:bottom-[130px] sm:right-8 z-30 flex gap-2 sm:gap-3 lg:bottom-[150px] lg:right-[101px]">
        <button
          type="button"
          @click="prevSlide"
          aria-label="Previous slide"
          class="flex h-9 w-9 sm:h-11 sm:w-11 items-center justify-center rounded-full bg-black/20 text-white shadow-sm backdrop-blur-md transition-all duration-300 hover:scale-110 hover:bg-black/40 active:scale-95"
        >
    ...
    <div
      class="relative z-20 mx-auto w-full max-w-[1021px] px-3 sm:px-4 lg:px-0"
      style="margin-top: -110px;"
    >
      <!-- Pill label -->
      <div class="flex justify-center">
        <div
          class="flex h-[28px] sm:h-[32px] w-[240px] sm:w-[310px] items-center justify-center rounded-tl-[20px] rounded-tr-[20px] rounded-br-[0px] rounded-bl-[0px] border border-white/70 bg-white/40 shadow-sm backdrop-blur-[6px] transition-all hover:bg-white/60"
        >
          <span class="text-xs sm:text-sm font-semibold tracking-wide text-slate-700">
            {{ t('hero.endorsed_by') }}
          </span>
        </div>
      </div>
